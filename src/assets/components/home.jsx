...
const Home = () => (
  <div className="md:p-4 p-3 homeMain bg-black lg:flex-row md:flex-row flex justify-center md:h-screen flex-col-reverse md:justify-between  w-full" style={{borderBottom: "2px solid rgba(255, 255, 255, 0.5)"}}>
    <div className="intro mt-28 text-5xl">
      ...
      <div className="skill-container md:h-16 h-28 overflow-hidden mt-3 font-bold">
        <div className="skills scroll-up-down-mobile md:scroll-up-down">
    ...
    <div className="img flex w-full md:mt-20 mt-24 justify-center items-center md:justify-end">
