const Home = () => (
  <div className="ml-12 homeMain relative bg-black md-flex-row flex justify-center flex-col-reverse md:justify-between w-11/12">
    <div className="intro mt-28 text-5xl">
      ...
      <div className="skill-container overflow-hidden mt-3 font-bold">
        <div className="skills scroll-up-down">
          <p className="skill-1 bg-gradient-to-r duration-1000 from-blue-500 hideothers via-purple-500 to-pink-700 bg-clip-text h-14 text-transparent font-bold text-5xl">
    ...
    <div className="img flex w-full mt-20 justify-end">
      <div className="outer-border flex justify-center items-center rounded-full bg-gradient-to-r from-blue-500 via-purple-500 to-pink-700">
        <div className="image bg-gradient from-blue-500 via-purple-500 to-pink-700 rounded-full overflow-hidden border-black">
          <img src="./src/assets/picture.png" className="h-96" alt="A picture"/>
        </div>
      </div>
    </div>
  </div>
